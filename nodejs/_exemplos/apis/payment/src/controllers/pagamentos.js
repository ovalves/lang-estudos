...
module.exports = (app) => {
        ...
        memcachedClient.get('pagamento-' + id, (erro, retorno) => {
            if (erro || !retorno) {
                ...
                pagamentoDao.buscaPorId(id, function(erro, resultado) {
                    ...
                    console.log(
                        'pagamento encontrado: ' + JSON.stringify(resultado)
                    );
                    res.json(resultado);
                    return;
                });
    ...
    app.post('/pagamentos/pagamento', (req, res) => {
        req.assert(
            ...
            'Forma de pagamento eh obrigatorio'
        ).notEmpty();
        req.assert(
            'pagamento.valor',
        ...
        pagamentoDao.salva(pagamento, function(erro, resultado) {
            if (erro) {
                ...
                memcachedClient.set(
                    ...
                    function(erro) {
                        console.log(
                            'nova chave adicionada ao cache: pagamento-' +
                                pagamento.id
                        );
                    }
                );
                ...
                if (pagamento.forma_de_pagamento == 'cartao') {
                    ...
                    clienteCartoes.autoriza(cartao, function(
                        exception,
                        request,
                        response,
                        retorno
